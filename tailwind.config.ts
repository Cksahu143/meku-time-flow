  ...
  theme: {
  	...
  	extend: {
  		...
  		boxShadow: {
  			...
  			premium: '0 20px 50px -12px hsl(var(--primary) / 0.2), 0 8px 16px -8px hsl(var(--primary) / 0.25)',
  			soft: '0 2px 8px -1px hsl(var(--foreground) / 0.08), 0 1px 2px -1px hsl(var(--foreground) / 0.04)',
  			depth: '0 4px 12px -2px hsl(var(--foreground) / 0.12), 0 2px 4px -2px hsl(var(--foreground) / 0.08)'
  		},
  		backgroundImage: {
  		...
  		keyframes: {
  			...
  			'pulse-glow': {
  				...
  				'50%': { boxShadow: '0 0 25px var(--primary-glow)' }
  			},
  			'zoom-in': {
