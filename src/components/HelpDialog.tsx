...
export const HelpDialog = ({ open, onOpenChange }: HelpDialogProps) => {
  const helpSections = [
    ...
    },
    {
      ...
      description: 'Your AI study buddy for understanding resources',
      steps: [
        'Open any resource and click the sparkle (✨) icon for AI tools',
        'Select "Ask CoCo" to start a chat about the resource',
        'CoCo reads the resource content and answers your questions',
        'Ask for explanations, examples, summaries, or clarifications',
        'Conversation streams in real-time with markdown formatting',
      ],
    },
    {
      icon: HelpCircle,
      title: 'AI Flashcards',
      description: 'Auto-generate study flashcards from any resource',
      steps: [
        'Click the sparkle (✨) icon on a resource card',
        'Select "Generate Flashcards" from the menu',
        'AI creates 8-12 flashcards with questions and answers',
        'Click cards to flip between question and answer',
        'Navigate between cards and regenerate for new ones',
      ],
    },
    {
      icon: HelpCircle,
      title: 'AI Slide Deck',
      description: 'Create presentation slides from resources',
      steps: [
        'Click the sparkle (✨) icon and select "Generate Slide Deck"',
        'AI creates 6-10 slides with titles, bullet points, and speaker notes',
        'Navigate slides using the thumbnail strip or arrow buttons',
        'Toggle speaker notes for additional context',
        'Regenerate for a fresh perspective on the material',
      ],
    },
    {
      icon: HelpCircle,
      ...
      steps: [
        'Click the sparkle (✨) icon and select "Generate Quiz"',
        'AI creates 8-10 multiple-choice questions from the resource',
        'Select answers and get instant feedback with explanations',
        'See your final score and review all answers at the end',
        'Retake the quiz with newly generated questions anytime',
      ],
    },
    {
      icon: Smartphone,
